        ...
        <div class="w-full bg-white py-4 px-6">
            <div class="flex justify-between items-center">
                <div x-data="{ isOpenMenu: false }" class="flex items-center gap-4">
                    ...
                    <header class="text-xl whitespace-nowrap">Activity Logs</header>
                </div>
                    ...
                    <tbody class="">
                        @forelse ($activity_log as $log)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 space-y-4 p-12">
                                ...
                                <td class="px-6 py-4">
                                    @if(class_basename($log->subject_type) === 'Chapter')
                                        Chapter
                                    @elseif(class_basename($log->subject_type) === 'User')
                                        User
                                    @elseif(class_basename($log->subject_type) === 'Alumni')
                                        Alumni
                                    @endif
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    @php
                                        $attributes = json_decode($log->properties, true)['attributes'] ?? [];
                                    @endphp
                                ...
                                <td class="px-6 py-4">
                                    @php
                                        $oldAttributes = json_decode($log->properties, true)['old'] ?? [];
                                    @endphp
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-4 text-gray-500 dark:text-white">No Results</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
